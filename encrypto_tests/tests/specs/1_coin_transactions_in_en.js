...
describe('coin transaction in 1 en; Проверить добавлление монеты в "Profile"  в профайл через поиск с нажатием кнопки [Add]', function(){
    ...
    it('PRECONDITION. Добавление монеты', function(){   
    ...
    it('PRECONDITION. Добавление монеты', function(){   
        ...
        const solana = 'Bitcoin'
        const attr_solana = Details.bitcoin.getAttribute('content-desc')
        expect(solana).toBe(attr_solana)
    ...
    it('STEP 1. Нажать кнопку [+] внизу страницы ', function(){  
    ...
    it('STEP 2. Из первого выпадающего меню выбрать "In"', function(){  
    ...
    it('STEP 3. Из второго выпадающего списка выбрать "Buy"', function(){ 
       ...
       const text_out = 'Buy'
       const attr_text_out = AddTransaction.buy.getAttribute('content-desc')
       expect(text_out).toBe(attr_text_out)

       AddTransaction.buy.click()
    })

    it('STEP 4. Ввести в поле "Количество" значение ', function(){ 
    ...
    it('STEP 5. В поле даты выбрать выбрать текущую или прошедшую дату', function(){ 

        driver.touchScroll(AddTransaction.dropdown_calendar_btc)
        AddTransaction.dropdown_calendar_btc.click()
    

    })
    
    it('STEP 6. В календаре нажать кнопку [Ок]', function(){ 
    ...
    it('STEP 7. Ввести в поле "USD" стоимость монеты вручную', function(){ 

    
        AddTransaction.usd_form_btc.click()
        AddTransaction.usd_form_btc.clear()
    ...
    it('STEP 8. Выбрать Кошелек из выпадающего списка', function(){ 
    ...
    it('STEP 9. Нажать кнопку [Save]', function(){ 
