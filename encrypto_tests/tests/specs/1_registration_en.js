...
describe('registration test 1 en; Проверить создание портфолио при выборе на онбординг скрин радиокнопку , "Master password only (the most secure)"с пустыми полями " ', function(){
    ...
    it('STEP 1-2. В поле "My portfolio" удалить текст; Поля "master password", "confirm password" оставить пустыми', function(){
    ...
    it('STEP 3. Нажать кнопку [Create]', function(){
    ...
    it('EXPECTED RESULT. Под полем "My portfolio" отображается информационное сообщение красным цветом "Please Enter name".  Под полем "master password" отображается информационное сообщение красным цветом "Please Enter password". Под полем "confirm password"  отображается информационное сообщение  красным цветом "Please re enter password"', function(){
