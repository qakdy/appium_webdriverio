...
describe('add coin test 2 en; Проверить добавление монеты в "Profile"   при скроллингев профайл без нажатия кнопок на экране "Details"', function(){
    ...
    it('STEP 2. Проскролить до необходимой монеты', function(){
        ...
        Add_Coin.enter_coin_en.setValue('bit')
    ...
    it('EXPECTED RESULT. Осуществляется переход на страницу "Profile". Добавленная монета отображается в списке монет с нулевыми значениями: - перевода стоимости транзакций по данной монете; - количество монет' , function(){
        ...
        // const add_solana = 'Cap.: $24.1B 8 Solana (SOL) 0.0 SOL 0.0$ $71.46 -18.7%'
        // const attr_solana = Myportfolio.add_solana.getAttribute('content-desc')
        // expect(add_solana).toBe(attr_solana)
