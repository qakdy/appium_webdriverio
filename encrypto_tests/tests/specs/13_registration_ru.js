...
describe('registration test 13 ru; Проверить создание портфолио при выборе на онбординг скрин   радиокнопку  "Только отпечаток пальца/FaceID(компромиссный вариант)" на экране "Безопастность"? или "Ничего, мне не о чем беспокоится " на экране "Безопастность" с измененным полем "Мое портфолио"', function(){
